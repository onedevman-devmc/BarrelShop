...
import mc.barrelshop.shops.events.ShopLoadedEvent;
import mc.barrelshop.shops.events.ShopUnloadedEvent;
...
public class BarrelShopManager implements Listener, EventListener {
    ...
    private static boolean hasCreationPermission(Player player, boolean isAdminShop) {
        if(isAdminShop) {
            return player.hasPermission("mc.barrelshop.shops.admin.create");
        }
        else return player.hasPermission("mc.barrelshop.shops.self.create");
    }
    ...
    private static boolean hasDeletionPermission(Player player, OfflinePlayer shopOwner, boolean isAdminShop) {
        if(isAdminShop) {
            return player.hasPermission("mc.barrelshop.shops.admin.delete");
        }
        else {
            if(shopOwner.getUniqueId().equals(player.getUniqueId()))
                return player.hasPermission("mc.barrelshop.shops.self.delete");
            else return player.hasPermission("mc.barrelshop.shops.others.delete");
        }
    }
    ...
    private static boolean hasManagementPermission(Player player, OfflinePlayer shopOwner, boolean isAdminShop) {
        if(isAdminShop) {
            return player.hasPermission("mc.barrelshop.shops.admin.manage");
        }
        else {
            if(shopOwner.getUniqueId().equals(player.getUniqueId()))
                return player.hasPermission("mc.barrelshop.shops.self.manage");
            else return player.hasPermission("mc.barrelshop.shops.others.manage");
        }
    }
